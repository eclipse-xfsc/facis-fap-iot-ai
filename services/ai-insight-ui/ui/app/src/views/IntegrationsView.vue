...
const tabs = [
  { label: 'Overview', to: '/integrations/overview', icon: 'pi-chart-bar' },
  { label: 'Adapters', to: '/integrations/adapters', icon: 'pi-link' },
  { label: 'Pipelines', to: '/integrations/pipelines', icon: 'pi-arrow-right-arrow-left' }
]
</script>
