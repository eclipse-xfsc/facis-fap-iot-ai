...
const tabs = [
  { label: 'Overview', to: '/provenance/overview', icon: 'pi-chart-bar' },
  { label: 'Audit Log', to: '/provenance/audit', icon: 'pi-list' },
  { label: 'Schema Compare', to: '/provenance/compare', icon: 'pi-copy' },
  { label: 'Data References', to: '/provenance/references', icon: 'pi-link' }
]
</script>
