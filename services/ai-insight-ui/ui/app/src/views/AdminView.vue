...
const tabs = [
  ...
  { label: 'Roles', to: '/admin/roles', icon: 'pi-shield' },
  { label: 'Access Control', to: '/admin/access', icon: 'pi-lock' },
  { label: 'Monitoring', to: '/admin/monitoring', icon: 'pi-chart-bar' },
  { label: 'Settings', to: '/admin/settings', icon: 'pi-cog' }
]
</script>
