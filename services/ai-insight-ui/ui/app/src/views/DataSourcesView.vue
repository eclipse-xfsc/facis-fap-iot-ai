...
const tabs = [
  { label: 'All Sources', to: '/data-sources/all', icon: 'pi-list' },
  { label: 'Types', to: '/data-sources/types', icon: 'pi-th-large' },
  { label: 'Health Monitor', to: '/data-sources/health', icon: 'pi-heartbeat' },
  { label: 'Raw Messages', to: '/data-sources/raw', icon: 'pi-code' }
]
</script>
