...
const tabs = [
  { label: 'Local Schemas', to: '/schemas/local', icon: 'pi-file' },
  { label: 'Remote Schemas', to: '/schemas/remote', icon: 'pi-cloud' },
  { label: 'Mappings', to: '/schemas/mappings', icon: 'pi-arrows-h' }
]
</script>
